...
module subContributorRole 'sub_perms.bicep' = {
...
resource ccpManagedIdOpRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(guidGen, linux_z1_sub_name, manangeIdentityOperatorRoleId, rg_name)
  properties: {
...
resource ccpNetAdminRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(guidGen, vnet_name, networkContributorRoleDefinitionId, rg_name)
  properties: {
